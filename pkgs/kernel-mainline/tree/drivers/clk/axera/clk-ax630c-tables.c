 ...
 *
 * 268 clocks over eight controllers: 1 PLL, 9 fixed-rate, 80 fixed-factor,
 * 53 muxes, 23 dividers, 102 gates. Per controller: common 135, mm 40, flash
 * 33, periph 27, dispc 14, cpu 11, vpu 7, pllc 1.
 *
 * 246 of those are the set the vendor CCF driver registers. The other 22 are
 ...
 * watchdogs (#75) and three for USB (#82). Anything that calls clk_get() on a
 * block the vendor drove by hand needs the same treatment.
 *
